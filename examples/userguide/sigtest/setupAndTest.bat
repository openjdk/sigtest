...
rem Wrapper script for the SetupAndTest command
rem 
rem Usage: 
rem setupAndTest.bat <impl-1-classes> <impl-2-classes> <package>
rem     <impl-1-classes> - path to reference implementation 
rem     <impl-2-classes> - path to implementation under test

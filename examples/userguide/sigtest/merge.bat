...
rem Wrapper script for the Merge command
rem 
rem Usage: 
rem sh merge.sh <sig-file-1> <sig-file-2> <output-file>
rem     <sig-file-1> - the first signature file
rem     <sig-file-2> - the second signature file
rem     <output-file> - the name of signature file to be generated
rem Environment settings:
rem CLASSPATH is set to contain the "sigtestdev.jar" or "sigtest.jar"

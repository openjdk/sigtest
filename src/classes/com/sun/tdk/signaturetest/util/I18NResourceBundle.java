...
/**
 * A class that lazily opens a package-specific resource bundle containing
 * localization data for a class.
 */
public class I18NResourceBundle extends ResourceBundle {

    /**
     * Get a package-specific resource bundle for a class containing
     * localization data. The bundle is named i18n.properties in the same
    ...
    /**
     * Create a resource bundle for the given name. The actual resource bundle
     * will not be loaded until it is needed.
     *
    ...
    /**
     * A required internal method for ResourceBundle. Load the actual resource
     * bundle, if it has not yet been loaded, then hand the request off to that
     * bundle. If the resource cannot be found, a message is printed to the
     * console and the result will be the original key.
     */
    ...
    /**
     * Returns the name of this bundle (useful for methods using bundle name
     * instead of instance, such as <code>Logger</code> creation,
     *

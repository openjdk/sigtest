 ...
 */
public class JakartaSignatureTest extends SigTest {
    ...
    public static void main(String[] args) {
        JakartaSignatureTest t = getInstance();
        t.run(args, new PrintWriter(System.err, true), null);
        t.exit();
    }

    protected static JakartaSignatureTest getInstance() {
        return new JakartaSignatureTest();
    }
...
//        long startTime = System.currentTimeMillis();
        ...
        mode = null;
        try {
            ClassLoader cl = JakartaSignatureTest.class.getClassLoader();

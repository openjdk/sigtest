...
public class Status {
    ...
    /**
     * Create a Status to indicate the unsuccessful outcome of a test: I.e. the
     * test completed, but the test determined that what was being tested did
     * not pass the test.
     *
    ...
    /**
     * Create a Status to indicate that an error occurred while trying to run a
     * test: I.e. the test did not complete for some reason, and so it could not
     * determine whether what was being tested passed or failed.
     *
    ...
    /**
     * Create a Status to indicate that the test was not run because under the
     * conditions given it was not applicable. This method is retained for
     * backwards compatibility only; the resultant object is of FAILED type.
     *
     * @param reason A short string describing why the test was not applicable.
     * @return a Status to indicate that a test failed because it was not
     * applicable
     * @deprecated
     */
     ...
     *
     * @param reason A short string indicating why the test has not yet been
     *               run.
     */
    ...
    /**
     * A return code indicating that the test was executed but the test reported
     * that it failed.
     *
     * @see #failed
     * @see #getType
     ...
     * occurred before the test could even be attempted. This is generally a
     * more serious error than FAILED.
     *
     * @see #getType
     */
    ...
    /**
     * A return code indicating that the test has not yet been run in this
     * context. (More specifically, no status file has been recorded for this
     * test in the current work directory.) This is for the internal use of the
     * harness only.
     *
     * @see #getType
     */
     ...
     *
     * @param aux if not null and not empty, it will be combined with the
     *            original reason.
     * @return if <em>aux</em> is null or empty, the result will be the same as
     * this object; otherwise, it will be a new object combining the original
     ...
     * @return if <em>aux</em> is null, the result will be the same as this
     * object; otherwise, it will be a new object combining the original status
     * reason and the additional information in <em>aux</em>.
     */
     ...
     *
     * @param s a string containing the string form of a Status as generated by
     *          {@link #toString}
     * @return the corresponding Status, or null if it could not be parsed
     * successfully
     * @see #exit
     */
    ...
    /**
     * Translate the type number to a descriptive string. For example, type 0
     * corresponds to the "Passed." string.
     *
     * @param typeNum A number between zero and NUM_STATES
     * @return null if the given integer was out of range, otherwise an
     * appropriate string.
     */
    ...
    /**
     * Create a Status object. See
     * {@link #passed}, {@link #failed}, {@link #error} etc. for more convenient
     * factory methods to create Status objects.
     *
    ...
    /**
     * A string used to prefix the status when it is written to System.err by
     * {@link #exit}.
     */
